  ...
  render(){   
    ...
    return(
      <View style={{ backgroundColor : 'white', }}>
        ...
        <TouchableOpacity style={{ marginLeft: 5, marginRight: 5 }} onPress={() => Actions.push('Details', { data : this.props.rowData, favorite: this.state.favorite, startTime : startTime, endTime : endTime, zipCode : zipCode, duration: duration } )}>
          <View>
            <ImageBackground
              source={ImgUrl}
