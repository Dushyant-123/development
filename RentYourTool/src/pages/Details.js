...
export default class DetailsPage extends Component {
  ...
  showAlert = () => {
    Alert.alert(
      'Your Tool Item has been Book Successfully',
      '',
      [
        { text: 'OK', onPress: () => Actions.excursions() },
  ...
  render(){
    const { userName, userProfileImageUrl, toolFavouriteStatus, toolImgUrl, toolName, toolRentCurrencyValue, toolId, userId, toolDsc, toolUseRule,  toolRating } = this.props.data;
        ...
        />
          <ScrollView styles={{ margin: 5, flex: 1 }}>
            ...
            <View style={{ flexDirection: 'row', marginLeft: 20, marginTop: 20, marginBottom: 80 }}>
              <TouchableOpacity style={{ flex: 1, marginRight: 10, padding: 15, backgroundColor: 'lightgray'}} onPress={() => Actions.push('ContactOwner', { data : this.props.data, token : this.state.token } )}>
                <Text style={{ color: '#ff8c00', fontWeight: 'bold', textAlign: 'center' }}> CONTACT OWNER </Text>
              </TouchableOpacity>
