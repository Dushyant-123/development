...
export default class ExcursionsScreen extends Component {
  ...
  render(){
    ...
    //onPress={() => Actions.push('ratingreview', { token: this.state.token, userId : userId, toolId: toolId} )}
    const UpcomingToolListComponent = (props) => {
      ...
      return(
        <TouchableOpacity onPress={() => Actions.push('excurstionsDetails', { data : props.rowData } )}>
          <View style={{ flexDirection: 'row', marginLeft: 20 }}>
            ...
            <View style={{ flexDirection: 'column', margin: 10, marginLeft: 30 }}>
              ...
              <View style={{ right: 0, flexDirection: 'row', marginTop: 5 }}>
                <TouchableOpacity style={{ right: 0, borderColor: 'black', borderWidth: 1, borderRadius: 15 }}>
    ...
    return(
      <View style={styles.outerContainer}>
        <Header
          ...
          centerComponent={{ text: 'RENTALS', style: { color: '#fff', fontWeight: 'bold', fontSize:20 } }}
